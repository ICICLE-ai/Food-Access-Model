...
You will need python and postgreSQL to run this project. Download postgreSQL if you have not already. Make sure to add the postGIS add-on when prompted! You can download postgres here: https://www.postgresql.org/download/
